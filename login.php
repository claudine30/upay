               ...
               <form action="" id="user-register">
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="address" class="control-label text-info">Course/Program</label>
                                <textarea rows="1" class="form-control form-control-border" id="course" name="course" required></textarea>
                            </div>
                            <div class="form-group">
